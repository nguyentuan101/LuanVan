...
<body>
    <?php 
        ...
        $detail_trieuchung = get_detail_trieuchung();
        $list_benh = get_detail_trieuchung_benh();
    ?>  <!-- php code -->
    ...
    <div class="symptom_detail">
        <label><?php print $detail_trieuchung[0]['label'];?></label>
        <div class="row1">
            <div class="con">
                <div class="hinhanh">
                    <img src="<?php print $detail_trieuchung[0]['img'];?>" alt="">
                </div>
                <div class="list-benh">
                    <p>Loại Bệnh</p>
                    <div class="text">
                            ...
                            foreach( $list_benh as $row ) {?>
                                <div class="element">
                                    <div class="name_benh">  
                                        ...
                                        Tỷ lệ:<span style="color: red"> <?php print $row['comment']; ?> %</span>
                                    </div>
                                </div>
                            <?php }
                            } ?>
